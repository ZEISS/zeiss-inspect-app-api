...
extensions = ['myst_parser', 'sphinx_rtd_theme', 'sphinx_favicon', 'sphinx.ext.githubpages', 'sphinx_sitemap', 'sphinxcontrib.newsfeed', 'myst_nb']
...
html_baseurl = 'https://zeiss.github.io/zeiss-inspect-app-api/2025/'
