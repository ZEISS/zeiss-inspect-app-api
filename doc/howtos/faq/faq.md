...
If you did not find an answer here, you might want to check <a href="https://qualityforum.zeiss.com/forum/30-customizations-app-development/" target="_blank" rel="noopener noreferrer">ZEISS Quality Forum - Customizations & App Development</a>.
...
See also [ZEISS Quality Tech Guide: Edit Expression (label background color)](https://techguide.zeiss.com/en/zeiss-inspect-2026/article/dlg_edit_dynamic_label_background_color_expression.html).
...
```{caution}
This section only applies to ZEISS INSPECT 2026 and earlier! No workaround in needed for later versions!
```
