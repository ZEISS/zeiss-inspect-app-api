...
For a complete runnable API example, see <a href="../../python_api/python_api.html#gom-api-extensions-sequence-customsequence">Complete example: A custom sequence creating a distance from two points</a>.
```
...
* <a href="../../python_api/python_api.html#gom-api-extensions-sequence-customsequence">Complete example: A custom sequence creating a distance from two points</a>
