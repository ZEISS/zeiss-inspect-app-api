...
* User defined **Dialogs** can be inserted into the script using RMB ► Insert ► Dialog... in the <a href="../using_add_on_editor/using_add_on_editor.html">Add-on Editor</a>.
