...
### gom.api.collectors.get_data

```{py:function} gom.api.collectors.get_data(id: str): dict

Return the data of a custom data collector.
:API version: 1
:param id: Custom data collector identifier.
:type id: str
:return: Dictionary containing the collector identifier and data.
:rtype: dict
```

The returned dictionary contains the collector identifier and its data.

The dictionary contains the following keys:

- `collector_id` (str) — The custom data collector identifier. Empty if the collector is not found.
- `data` (Any) — The data provided by the custom data collector. Empty if the collector is not found or if no data
has been collected yet.

**Example:**

```python
import gom.api.collectors

result = gom.api.collectors.get_data('com.example.my_collector')
if result:
    print(result['data'])
```
...
extends the view system of ZEISS INSPECT, the category is 'customviews'.
...
```{py:function} gom.api.custom_checks_util.is_curve_checkable(element: gom.Object): bool
...
This function checks if the given element can be inspected like a curve in the context of custom
elements. Please see the custom element documentation for details about the underlying scheme.

### gom.api.custom_checks_util.is_scalar_checkable

```{py:function} gom.api.custom_checks_util.is_scalar_checkable(element: gom.Object): bool
...
This function checks if the given element can be inspected like a scalar value in the context of custom
elements. Please see the custom element documentation for details about the underlying scheme.

### gom.api.custom_checks_util.is_surface_checkable

```{py:function} gom.api.custom_checks_util.is_surface_checkable(element: gom.Object): bool
...
This function checks if the given element can be inspected like a surface in the context of custom
elements. Please see the custom element documentation for details about the underlying scheme.
...
This API defines various functions for handling custom elements (actuals, inspections, nominal, diagrams, ...)
It is used mostly internally by the custom element framework.

### gom.api.customelements.get_dimension_definition

```{py:function} gom.api.customelements.get_dimension_definition(typename: str): Any
...
```{py:function} gom.api.customelements.get_dimensions(): [str]
...
```{py:function} gom.api.customelements.get_element_from_id(element_id: str): Any
...
only and should be used with care. For example, in custom sequences, the child elements of
...
```{py:function} gom.api.customelements.get_id_for_element(element: Any): str
...
```{py:function} gom.api.customelements.get_inspection_definition(typename: str): Any
...
```{py:function} gom.api.customelements.get_instructions(element: Any): Any
...
Each custom element must be computed for one or more stages. In the case of a preview or
...
#### gom.api.extensions.CustomCalculationElement.__init__

```{py:function} gom.api.extensions.CustomCalculationElement.__init__(self: Any, id: str, category: str, description: str, element_type: str, callables: Any, properties: Any): None

:param id: Unique contribution id, like `special_point`
:type id: str
:param category: Custom element type id, like `customelement.actual`
:type category: str
...
```{py:function} gom.api.extensions.CustomCalculationElement.compute(self: Any, context: Any, values: Any): None
...
```{py:function} gom.api.extensions.CustomCalculationElement.compute_stage(self: Any, context: Any, values: Any): None
...
```{py:function} gom.api.extensions.CustomCalculationElement.compute_stages(self: Any, context: Any, values: Any): None
...
#### gom.api.extensions.CustomElement.__init__

```{py:function} gom.api.extensions.CustomElement.__init__(self: Any, id: str, category: str, description: str, callables: Any, properties: Any): None

:param id: Unique contribution id, like `special_point`
:type id: str
:param category: Custom element category id, like `customelement.actual`
:type category: str
:param description: Human readable contribution description
:type description: str
```
...
```{py:function} gom.api.extensions.CustomElement._dialog_callable(self: Any, context: Any, args: Any): None

:param context: Script context object.
:type context: Any
:param args: Dialog execution arguments (version, name, values, …).
:type args: Any
:return: The result of `dialog()`, or `args` unchanged when `dialog()` returns `None`.
:rtype: None
```
...
```{py:function} gom.api.extensions.CustomElement.add_diagram_data(self: Any, diagram_data: List, diagram_id: str, service_id: str, element_data: Dict[str, Any]): None
...
```{py:function} gom.api.extensions.CustomElement.add_log_message(self: Any, context: Any, level: Any, message: Any): None
...
```{py:function} gom.api.extensions.CustomElement.add_view_data(self: Any, view_data: List, element_property: str, element_data: Dict[str, Any]): None
...
```{py:function} gom.api.extensions.CustomElement.apply_dialog(self: Any, dlg: Any, result: Any): None
...
```{py:function} gom.api.extensions.CustomElement.check_list(self: Any, values: Dict[str, Any], key: str, expected: type, length: int): None
...
```{py:function} gom.api.extensions.CustomElement.check_target_element(self: Any, values: Dict[str, Any]): None
```
...
```{py:function} gom.api.extensions.CustomElement.check_value(self: Any, values: Dict[str, Any], key: str, expected: type): None
...
```{py:function} gom.api.extensions.CustomElement.dialog(self: Any, context: Any, args: Any): None
...
This function is called to create the dialog for the custom element. The dialog is used to
...
```{py:function} gom.api.extensions.CustomElement.event(self: Any, context: Any, event_type: Any, parameters: Any): bool
...
```{py:function} gom.api.extensions.CustomElement.event_handler(self: Any, context: Any, event_type: Any, parameters: Any): bool
```
...
```{py:function} gom.api.extensions.CustomElement.finish(self: Any, context: Any, results_states_map: Any): None
...
```{py:function} gom.api.extensions.CustomElement.initialize_dialog(self: Any, context: Any, dlg: Any, args: Any): bool
...
```{py:function} gom.api.extensions.CustomElement.is_visible(self: Any, context: Any): bool

:return: `True` if the element is visible in the menus.
:rtype: bool
```

This function is called to check if the custom element is visible in the menus. This is usually the case if
...
```{py:function} gom.api.extensions.CustomElement.show_dialog(self: Any, context: Any, args: Any, url: Any): None
...
The classes in this module are used to define custom actual elements. These elements are used to generate
...
##### gom.api.extensions.actuals.CustomActual.__init__

```{py:function} gom.api.extensions.actuals.CustomActual.__init__(self: Any, id: str, description: str, element_type: str, help_id: str): None

:param id: Custom actual id string
:type id: str
...
##### gom.api.extensions.diagrams.CustomDiagram.__init__

```{py:function} gom.api.extensions.diagrams.CustomDiagram.__init__(self: Any, id: str, description: str, diagram_type: str, properties: Dict[str, Any], callables: Dict[str, Any]): None
...
```{py:function} gom.api.extensions.diagrams.CustomDiagram.check_and_filter_partitions(self: Any, partitions_in: List[List[int]], cnt_elements: int): None
...
:param description: Human readable contribution description
:type description: str
:param bundle: Name of the bundle where the diagram view is defined (used for diagram type identification)
:type bundle: str
:param stylesheet: Optional stylesheet for the diagram view
:type stylesheet: str
:param supported_properties: List of supported properties for this diagram view (optional, used for validation and documentation purposes)
:type supported_properties: List[str]
:param functions: List of additional functions for this diagram view (optional)
:type functions: List[Any]
:param signals: List of additional signals for this diagram view (optional)
...
##### gom.api.extensions.nominals.CustomNominal.__init__

```{py:function} gom.api.extensions.nominals.CustomNominal.__init__(self: Any, id: str, description: str, element_type: str, help_id: str): None

:param id: Custom nominal id string
:type id: str
:param description: Human readable name, will appear in menus
:type description: str
:param element_type: Type of the generated element (point, line, ...)
...
```{py:function} gom.api.extensions.sequence.CustomSequence.get_child_elements(leading_element: Any): Any
...
```{py:function} gom.api.extensions.sequence.CustomSequence.get_leading_element(child_element: Any): Any
...
```{py:function} gom.api.extensions.sequence.CustomSequence.get_sequence_elements(leading_element: Any): Any
...
##### gom.api.extensions.views.CustomCanvas.__init__

```{py:function} gom.api.extensions.views.CustomCanvas.__init__(self: Any, id: str, description: str, renderer: str, functions: List[Any], properties: Dict[str, Any], bundle: str): None
...
:type properties: Dict[str, Any]
:param bundle: Packages NPM bundle this custom view related on. (OPTIONAL, default: None).
:type bundle: str
```
...
##### gom.api.extensions.views.CustomEditor.__init__

```{py:function} gom.api.extensions.views.CustomEditor.__init__(self: Any, id: str, content_category: str, description: str, bundle: str, stylesheet: str, functions: List[Any], signals: List[str], properties: Dict[str, Any]): None
...
:param description: Human readable name, will appear in menus etc. (REQUIRED)
:type description: str
:param bundle: Packages NPM bundle this custom view related on. (REQUIRED)
:type bundle: str
...
```{py:function} gom.api.extensions.views.CustomEditor.extract_data(self: Any, content: str, json: List[Any]): None
...
```{py:function} gom.api.extensions.views.CustomEditor.get_data_types(self: Any, content: str, files: List[str]): None
...
```{py:function} gom.api.extensions.views.CustomEditor.prepare_data(self: Any, content: str, data: List[tuple[str, Any]], readonly: bool): None
...
##### gom.api.extensions.views.CustomView.__init__

```{py:function} gom.api.extensions.views.CustomView.__init__(self: Any, id: str, viewtype: str, description: str, functions: List[Any], properties: Dict[str, Any], callables: Dict[str, Any], signals: List[str]): None

:param id: Globally unique custom view id string (REQUIRED)
:type id: str
:param viewtype: Type of the custom view. Supported values are 'canvas', 'editor' and 'utility'. (REQUIRED)
:type viewtype: str
:param description: Human readable name, will appear in menus etc. (REQUIRED)
:type description: str
:param functions: List of functions that can be called by the JavaScript renderer (OPTIONAL, default: []).
...
### gom.api.interpreter.get_executing_script_file

```{py:function} gom.api.interpreter.get_executing_script_file(): str

Get the file path of the currently executing script if it is loaded from disk
:API version: 1
:return: Absolute path to the currently executing script file as a string
:rtype: str
```
...
current_script = gom.api.interpreter.get_executing_script_file()
print('Executing script file:', current_script)
```
...
- REMOTE: Service is managed by a remote interpreter. It cannot be started or stopped via
this API.
